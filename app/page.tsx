...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#f3f4f6]">
      ...
      {/* TOP HEADER */}
      <div className="h-[74px] bg-white border-b border-gray-300 flex items-center px-16">
      ...
      <div className="flex items-center justify-center py-20">
        ...
        <div className="w-[440px] bg-white rounded-xl shadow-sm p-8 border border-gray-100">
          ...
          {/* TITLE */}
          <h2 className="text-[38px] font-semibold text-center mb-10 text-black">
            Restro Login
          </h2>
          ...
          <div className="mb-6">
            ...
            <label className="block text-[15px] mb-2 font-medium text-black">
              Mobile Number
            </label>
